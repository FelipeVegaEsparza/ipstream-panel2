  ...
  return (
    <div className="space-y-6">
      ...
      {loading ? (
        ...
        <Tabs defaultValue="servidores" className="space-y-6">
          <TabsList className="grid w-full md:w-auto grid-cols-2 bg-gray-800 border-gray-700">
            <TabsTrigger value="servidores" className="data-[state=active]:bg-cyan-600">Servidores</TabsTrigger>
            <TabsTrigger value="clientes" className="data-[state=active]:bg-cyan-600">Clientes</TabsTrigger>
          </TabsList>

          <TabsContent value="servidores" className="space-y-5">
