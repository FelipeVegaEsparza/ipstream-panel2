// =====================================================
// /api/dashboard/streaming/playlists/[id]/reorder — POST
// =====================================================
...
import { streamingReorderSchema } from '@/lib/validations'
...
export async function POST(
  ...
  try {
    ...
    const parsed = streamingReorderSchema.safeParse(body)
    if (!parsed.success) {
    ...
    const result = await streamingClient.reorderPlaylist(ctx.clientId, params.id, parsed.data.trackIds)
    ...
    console.error('[streaming/playlist reorder]', err)
