// =====================================================
// Account PDF — generación de la "Cuenta del Mes" (jsPDF)
// =====================================================
// Reutilizado por la ruta de descarga (/api/admin/clients/[id]/account-pdf)
// y por el motor de email (adjunto de boleta).
...
export interface AccountPdfResult {
  buffer: ArrayBuffer
  base64: string
  fileName: string
}
...
/**
 * Genera el PDF de la cuenta del mes para un cliente.
 * Lanza si el cliente no existe.
 */
export async function generateAccountPdf(
  clientId: string,
  message = ''
): Promise<AccountPdfResult> {
